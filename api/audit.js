...
function buildEmailHtml(lead) {
  var c = lead.checks;
  var row = function (label, val) { return '<tr><td style="padding:6px 12px;color:#94978B">' + label + '</td><td style="padding:6px 12px;color:#111111;font-weight:600">' + val + '</td></tr>'; };
  ...
  return '' +
    ...
    means +
    gapEmail +
    '<div style="margin-top:22px;padding:20px;border:1px solid #C6EE3A;border-radius:6px;background:#fdfbf7">' +
      '<div style="font-size:11px;letter-spacing:1px;text-transform:uppercase;color:#8FB024;font-weight:700;margin-bottom:6px">That was the quick scan</div>' +
      ...
      '<a href="https://www.earvinlaureano.com/pricing/audit" style="background:#C6EE3A;color:#0c0c0c;padding:10px 18px;border-radius:4px;text-decoration:none;font-weight:700">Book my full audit</a>' +
    '</div>' +
